...
%>
	<h2 align="center">
		<font><strong>Non-Production System</strong></font>
	</h2>
...
String sql="Select * from nonprodsystem";
...
%>
	...
	<form action="AddingNonProd.jsp">
		<input type="submit" value="Add">
	</form>

	<input type="submit" id="DeletenonProd" value="Delete">
