...
@WebServlet("/addingnonproddata")
public class addingnonproddata extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public addingnonproddata() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String systemTest="nonprodsystem";
		...
		response.sendRedirect("NonProdLink.jsp");
	}
